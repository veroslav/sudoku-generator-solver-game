...
public class Puzzle {
	...
	private static final String DEFAULT_URL_SOURCE = "https://github.com/veroslav/sudoku-generator-solver-game";
	private static final String DEFAULT_DESCRIPTION = "A puzzle generated by SuDonkey";
	private static final String DEFAULT_AUTHOR = "SuDonkey Software";
	...
	public String getCreationDate() {
		...
		final int monthValue = creationDate.get(Calendar.MONTH) + 1;
		final String month = monthValue < 10? "0" + monthValue : String.valueOf(monthValue); 
		
		final StringBuilder sb = new StringBuilder();
		sb.append(creationDate.get(Calendar.YEAR));
		sb.append(dateSeparator);
		sb.append(month);
		sb.append(dateSeparator);
		sb.append(creationDate.get(Calendar.DAY_OF_MONTH));
